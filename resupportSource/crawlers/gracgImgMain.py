...
# import config.crawlers.storage.persistenceStsyem as mongdb
# import datetime
# import config.crawlers.storage.analysis.bufferStruct as util
...
#         try:
#             response = requests.get(url="https://www.gracg.com/"+img_url, headers=self.headers, stream=True, timeout=10)
